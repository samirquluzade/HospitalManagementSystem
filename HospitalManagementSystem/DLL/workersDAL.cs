...
namespace HospitalManagementSystem.DLL
{
    class workersDAL
    {
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                string sql = "Select * FROM tbl_ishchiler WHERE ID LIKE '%" + keywords + "%' OR Ad LIKE '%" + keywords + "%' OR Soyad LIKE '%" + keywords + "%' OR Yaş LIKE '%" + keywords + "%' OR Əmək_haqqı LIKE '%" + keywords + "%' OR Bölmə LIKE '%" + keywords + "%' OR Vəzifə LIKE '%" + keywords + "%'";
        ...
        public DataTable Select()
        {
            ...
            try
            {
                string sql = "Select * FROM tbl_ishchiler";
